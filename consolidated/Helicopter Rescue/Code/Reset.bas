'
'        Reset-File copyright 2021 Arnold Kramer T&T WARE
'
'        ver.20210426 2.23
'
'
...
waarde$ = "V2.23": dx = 2: dy = 2: GOSUB PlaatsTekstLinksUitlijnWit
...
dx = 236: dy = 297: waarde$ = "CANCEL": GOSUB PlaatsZwartOpGrijs

x1 = 324: y1 = 285: x2 = 432: y2 = 315: GOSUB TekenBlok
dx = 365: dy = 297: waarde$ = "OK": GOSUB PlaatsZwartOpGrijs
...
i$ = INKEY$
Mouse 3
IF b = 1 AND h > 208 AND h < 432 AND v > 130 AND v < 150 THEN _SNDPLAYCOPY Click&: GOSUB rescuecoordinates
IF b = 1 AND h > 208 AND h < 432 AND v > 160 AND v < 180 THEN _SNDPLAYCOPY Click&: GOSUB vehicles
IF b = 1 AND h > 208 AND h < 432 AND v > 190 AND v < 210 THEN _SNDPLAYCOPY Click&: GOSUB blackboxeshighscores
IF b = 1 AND h > 208 AND h < 432 AND v > 220 AND v < 240 THEN _SNDPLAYCOPY Click&: GOSUB defaultfiles
IF b = 1 AND h > 208 AND h < 432 AND v > 250 AND v < 270 THEN _SNDPLAYCOPY Click&: GOSUB recorddemo
IF b = 1 AND h > 208 AND h < 316 AND v > 285 AND v < 315 THEN _SNDPLAYCOPY Click&: GOTO cancel
IF b = 1 AND h > 324 AND h < 432 AND v > 285 AND v < 315 THEN _SNDPLAYCOPY Click&: GOTO OK
IF i$ = CHR$(27) GOTO Systeemeinde
IF i$ = "!" AND b = 1 AND h > 1 AND h < 36 AND v > 1 AND v < 8 THEN TurboHS = 1: _SNDPLAYCOPY Click&: GOSUB blackboxeshighscores
GOTO Label1
...
IF b3 = 1 THEN
    ...
    SELECT CASE TurboHS
        CASE 0
            PlayerName$(1) = "------------": PlayerScore&(1) = 5000: PlayerLevel(1) = 0: FuelTotal#(1) = 0: PlayerSeconds&(1) = 0
            PlayerName$(2) = "------------": PlayerScore&(2) = 4500: PlayerLevel(2) = 0: FuelTotal#(2) = 0: PlayerSeconds&(2) = 0
            PlayerName$(3) = "------------": PlayerScore&(3) = 4000: PlayerLevel(3) = 0: FuelTotal#(3) = 0: PlayerSeconds&(3) = 0
            PlayerName$(4) = "------------": PlayerScore&(4) = 3500: PlayerLevel(4) = 0: FuelTotal#(4) = 0: PlayerSeconds&(4) = 0
            PlayerName$(5) = "------------": PlayerScore&(5) = 3000: PlayerLevel(5) = 0: FuelTotal#(5) = 0: PlayerSeconds&(5) = 0
            PlayerName$(6) = "------------": PlayerScore&(6) = 2500: PlayerLevel(6) = 0: FuelTotal#(6) = 0: PlayerSeconds&(6) = 0
            PlayerName$(7) = "------------": PlayerScore&(7) = 2000: PlayerLevel(7) = 0: FuelTotal#(7) = 0: PlayerSeconds&(7) = 0
            PlayerName$(8) = "------------": PlayerScore&(8) = 1500: PlayerLevel(8) = 0: FuelTotal#(8) = 0: PlayerSeconds&(8) = 0
            PlayerName$(9) = "------------": PlayerScore&(9) = 1000: PlayerLevel(9) = 0: FuelTotal#(9) = 0: PlayerSeconds&(9) = 0
            PlayerName$(10) = "------------": PlayerScore&(10) = 500: PlayerLevel(10) = 0: FuelTotal#(10) = 0: PlayerSeconds&(10) = 0
        CASE 1
